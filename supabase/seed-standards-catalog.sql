...
values
  ('0da3d556-f580-565c-9484-f7f84c013f1e', 'Idaho Content Standards (2022 revision)', 'US-ID', 'US-ID',
   'ELA/Math: independent. Science: Framework-based own. LOW CONFIDENCE: degree of 2022 departure from CCSS unclear. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: independent. Science: Framework-based own. LOW CONFIDENCE: degree of 2022 departure from CCSS unclear. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('5f48d39e-543d-583e-ae2f-b82eafd7da04', 'Louisiana Student Standards (2016; 2025 review underway)', 'US-LA', 'US-LA',
   'ELA/Math: CCSS-derived revision. Science: NGSS verbatim. LOW CONFIDENCE: independence level disputed; 2025 review may shift. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: NGSS verbatim. LOW CONFIDENCE: independence level disputed; 2025 review may shift. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('afb3a5fb-ebc9-5d06-816a-356cb531d31e', 'NC Standard Course of Study (new ELA SCoS 2027-28)', 'US-NC', 'US-NC',
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not directly verified. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not directly verified. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
insert into standards_frameworks
  (id, name, short_code, jurisdiction, description, provenance, max_depth,
   ...
   machine_readable, source_links, catalog_notes)
values
  ('d52439c7-4941-5aef-a96e-17ec936e975c', 'North Dakota Academic Content Standards', 'US-ND', 'US-ND',
   'ELA/Math: CCSS-derived revision. Science: Framework-based own. LOW CONFIDENCE: current official name not confirmed from ND DOE. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: Framework-based own. LOW CONFIDENCE: current official name not confirmed from ND DOE. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('81399dbb-c3ac-53e7-b587-baede1b55421', 'Ohio''s Learning Standards', 'US-OH', 'US-OH',
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not fetched. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not fetched. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('8ac6a623-71de-5e2e-baf5-7abd1690ec13', 'PA Core Standards', 'US-PA', 'US-PA',
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not verified. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not verified. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('2346688d-3505-5b55-b6c8-09722fc2f311', 'South Carolina College- and Career-Ready Standards (ELA 2024, Math 2023)', 'US-SC', 'US-SC',
   'ELA/Math: independent. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not verified. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: independent. Science: Own (independent). LOW CONFIDENCE: science stance per baseline, not verified. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
...
values
  ('79466cf0-adb6-5bb0-b16c-2239f0f16780', 'West Virginia College- and Career-Readiness Standards', 'US-WV', 'US-WV',
   'ELA/Math: CCSS-derived revision. Science: Framework-based own. LOW CONFIDENCE: official current title not confirmed from DOE. As of 2026-06; via Common Standards Project / CASE where available.', 'catalog', 3,
   ...
   null, 'State publication', 'unverified'::framework_commercial_use,
   null, array['pdf','html']::text[], '[]'::jsonb,
   'ELA/Math: CCSS-derived revision. Science: Framework-based own. LOW CONFIDENCE: official current title not confirmed from DOE. As of 2026-06; via Common Standards Project / CASE where available.')
on conflict (id) do update set
  name = excluded.name, short_code = excluded.short_code,
  jurisdiction = excluded.jurisdiction, description = excluded.description,
  authority = excluded.authority, country_code = excluded.country_code,
