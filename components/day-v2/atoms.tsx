...
// atoms.tsx — the shared visual atoms for the three v2 Day frames (DayA/B/C).
// Ported from the design bundle's views-shared.jsx (SubjGlyph / StatusDot) plus
// the repo's three-tier forking cue vocabulary (WeekEditBoard's moved-arrow +
// "Modified" Badge), so all three frames speak the same fork language
// (CLAUDE.md §2). Subject color arrives through the `.cp-subj.<cls>` cascade
// (var(--c)/--cl/--cd) — never a hard-coded hue.
...
/** The status→dot-color class on day-v2.module.css. */
