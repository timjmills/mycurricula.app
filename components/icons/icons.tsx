...
//
// Stroked, Lucide-style vocabulary matching the rest of the repo. First
// extracted from components/daily/ResourceComposer.tsx; several other
// component families still carry local copies of CloseIcon / ChevronDownIcon
// variants — consolidate them here as they're touched.
...
export function PhotoIcon(): ReactNode {
  return (
    <svg
      width="22"
      height="22"
...
export function SmallXIcon(): ReactNode {
  return (
    <svg
      width="12"
      height="12"
...
export function MoreDotsIcon(): ReactNode {
  return (
    <svg
      width="16"
      height="16"
...
export function CapturedTypeIcon({
  type,
}: {
