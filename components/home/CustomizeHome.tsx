...
// On-page Customize control for the home screen: mode (Calm / Full / Custom),
// per-row toggles (Custom), and the soft-photo toggle. Controlled by the single
// useHomeLayout() instance the page owns, so the hero + rows + this popover all
// share one source of truth. SSR-safe: renders nothing until hydrated.
...
export function CustomizeHome({ layout }: { layout: HomeLayout }) {
  const {
    mode,
    rows,
    showPhoto,
  ...
  return (
    <div className={styles.customize}>
      ...
      {open && (
        <div className={styles.panel} role="dialog" aria-label="Customize home screen">
          <p className={styles.head}>Home layout</p>
