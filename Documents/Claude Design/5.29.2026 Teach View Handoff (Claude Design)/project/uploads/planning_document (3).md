...
### Phase 1B — Filling in Phase 1 during fall semester (~6-8 weeks of shipping iteratively)
...
**Phase 1A + 1B together = original Phase 1 scope.** The split is purely about delivery sequence — 1A ships in late August so the team can start using it; 1B fills in throughout fall.
...
### Phase 3 — Resources, annotation, interventions, admin (open-ended; late 2027 onward)

**Replaces:** Padlets (#1) + adds tiered intervention support + administrative reporting.
