...
const TopBar = () => (
  <div style={{
    ...
    <span style={{ display: "inline-flex", alignItems: "center", gap: 3, fontSize: 12.5, fontWeight: 600, color: T.ink2 }}>
      Grade 5 <Icon name="chevD" s={13} />
    </span>
    ...
    <div style={{
      ...
      padding: "6px 11px", background: "#F3F4F6", borderRadius: 8,
      width: 260, color: T.ink3,
    }}>
      <Icon name="search" s={14} />
      <span style={{ fontSize: 12.5, fontWeight: 500 }}>Search MyCurricula</span>
    </div>
    <span style={{
      width: 30, height: 30, borderRadius: 999, background: T.blue, color: "#fff",
      display: "inline-flex", alignItems: "center", justifyContent: "center",
    }}><Icon name="plus" s={14} /></span>
    <span style={{ position: "relative", color: T.ink2 }}>
      <Icon name="bell" s={18} />
      <span style={{
        position: "absolute", top: -3, right: -4,
        background: T.rose, color: "#fff", borderRadius: 999,
        fontSize: 9, fontWeight: 800, padding: "1px 5px",
      }}>2</span>
    </span>
    <span style={{ color: T.ink2 }}><Icon name="help" s={18} /></span>
    <span style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, background: "#fff" }}>
          ...
          <div style={{ flex: 1, position: "relative", padding: 18, overflow: "auto", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
              ...
              <span style={{ width: 56, height: 56, borderRadius: 14, background: T.blueTile, color: T.blueDeep, display: "inline-flex", alignItems: "center", justifyContent: "center" }}><Icon name="plus" s={26} /></span>
              <div style={{ fontSize: 22, fontWeight: 800, color: T.ink, letterSpacing: -0.3 }}>Add your first widget</div>
              <div style={{ fontSize: 13, color: T.ink2, lineHeight: 1.55 }}>This Warm-Up board is empty. Drag a resource from the right panel, or pick a widget below to get started.</div>
              <div style={{ display: "flex", gap: 7, flexWrap: "wrap", justifyContent: "center", marginTop: 6 }}>
                {[
                  ["Timer", "#FEF3C7", "#92400E"],
                  ["I Can", "#DBEAFE", "#1E3A8A"],
                  ["Groups", "#D1FAE5", "#065F46"],
                  ["Agenda", "#FCE7F3", "#9D174D"],
                  ["Notes", "#FEF3C7", "#92400E"],
                  ["Slides", "#DBEAFE", "#1E3A8A"],
                  ["YouTube", "#FEE2E2", "#991B1B"],
                  ["Poll", "#EDE9FE", "#5B21B6"],
                ].map(([lbl, bg, fg], i) => (
                  <span key={i} style={{ padding: "5px 12px", background: bg, color: fg, borderRadius: 999, fontSize: 11.5, fontWeight: 700 }}>+ {lbl}</span>
                ))}
              </div>
            </div>
            <ToolDock />
