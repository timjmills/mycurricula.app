...
For example, a token of `DO8s/Cy/3L3KPTE6i+x0zA=` becomes:

```
https://mycurricula.app/weekly?claude=DO8s%2FCy%2F3L3KPTE6i%2Bx0zA%3D
```
...
```
https://mycurricula.app/auth/claude-login?token=DO8s%2FCy%2F3L3KPTE6i%2Bx0zA%3D&next=/weekly
```
