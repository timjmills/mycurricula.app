...
insert into master_core_lesson_events
  (id, unit_id, subject_id, week_number, day_of_week, title, directions, learning_objectives, notes, resources, standards, display_order_within_day)
  values ('83fd6e4a-1ca4-5cf8-899d-7cdb69547a0c', 'ac3fb91e-f83d-504a-a2b7-f31871c14d71', '00000000-0000-0000-0000-0000000005d2', 12, 'sun'::weekday, 'Wonder, chs 14–17 — point of view', 'First-person narrator shift from August to Via. Students annotate three places the same event is reframed.', '["I can describe how a narrator''s point of view influences events."]'::jsonb, 'Pair anyone who was absent for ch 13 with a partner who has read it.', '[{"type":"doc","label":"Annotation sheet","url":"https://docs.google.com/document/d/1mGJ_yJ8sZ4uV4dVL9z6KZpL_2H8KdH8XzNgN6Hpx0fM/edit","provider":"gdocs"},{"type":"website","label":"Lit-circle prompts"}]'::jsonb, array['61b8841c-24fc-5b65-aeba-30a4921618e1', 'b8e2eb84-84b9-5f2c-ba64-5e92ae39f0f7']::uuid[], 0)
  on conflict (id) do nothing;
insert into master_core_lesson_events
  (id, unit_id, subject_id, week_number, day_of_week, title, directions, learning_objectives, notes, resources, standards, display_order_within_day)
  values ('433757e3-2b47-54db-9f27-c64c039b81b5', 'ac3fb91e-f83d-504a-a2b7-f31871c14d71', '00000000-0000-0000-0000-0000000005d2', 12, 'tue'::weekday, 'Literacy Centers (90 min)', 'Bell rings at 9:35 — Group A starts at reading, B at grammar, C at writing. Rotate at the chime. I conference at the writing station throughout.', '["I can rotate through three literacy stations and complete each task."]'::jsonb, 'Print rotation chart for the back wall. Start the group that needs the longest at the writing station.', '[{"type":"image","label":"Rotation chart"},{"type":"doc","label":"Conferring tracker"}]'::jsonb, array['b8e2eb84-84b9-5f2c-ba64-5e92ae39f0f7', '395b5165-beaa-5bed-9d89-a2eb51d5945f', '88439755-d52b-54a9-aaf9-6ba633858f0f']::uuid[], 2)
  on conflict (id) do nothing;
insert into master_core_lesson_events
  (id, unit_id, subject_id, week_number, day_of_week, title, directions, learning_objectives, notes, resources, standards, display_order_within_day)
